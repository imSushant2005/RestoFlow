    ...
    <div className="min-h-[100dvh] flex items-center justify-center bg-slate-950 px-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl">
        <div className="flex items-center gap-3 mb-6">
          <img src="/bhojflow-logo.png" alt="BHOJFLOW" className="h-10 w-10 rounded-xl object-contain" />
          <div>
            <p className="text-xs uppercase tracking-[0.18em] text-slate-500 font-black">BHOJFLOW</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              autoFocus
              placeholder="staff@bhojflow.demo"
          ...
          <div className="rounded-xl bg-slate-800 border border-slate-700 px-3 py-2 text-xs text-slate-400">
            ...
            <p>Email: <span className="font-mono text-blue-300">staff@bhojflow.demo</span></p>

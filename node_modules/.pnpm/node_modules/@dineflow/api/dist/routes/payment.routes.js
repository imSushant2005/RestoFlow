...
router.post('/create-order', (0, auth_middleware_1.requireRole)(['OWNER']), PaymentController.createSubscriptionOrder);
router.post('/verify', (0, auth_middleware_1.requireRole)(['OWNER']), PaymentController.verifyPayment);

...
export declare const getAssistedSummary: (req: Request, res: Response) => Promise<void>;
...
export declare const lookupAssistedCustomer: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const createAssistedOrder: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
